...
# 🗂️ Charger toutes les images en niveaux de gris
images = [cv2.imread(path, cv2.IMREAD_GRAYSCALE) for path in image_paths]

# Vérifier que les images sont chargées
print(f"{len(images)} images chargées.")

# 📌 Choisir deux images consécutives pour calculer le déplacement
img1 = images[1]
img2 = images[2]

# 🌀 Calculer le champ de déplacement optique (dense optical flow)
...
# 🖌️ Visualiser le champ de déplacement en couleur
